...
SSD1306::SSD1306() {
    ...
    // sendCommand(0x12);  // Height = 64
    sendCommand(0x02);  // Height = 32
...
void SSD1306::sendFramebuffer(uint8_t *buffer) {
    ...
    sendCommand(0x00);  // Start at col 0
    sendCommand(0x7F);  // Stop at col 127

    sendCommand(SSD1306_PAGEADDR);
    sendCommand(0x00);  // Start at page 0
    sendCommand(0x07);  // Stop at page 7
